...
-- --------------------------------------------------
-- Date Created: 11/06/2018 19:47:56
-- Generated from EDMX file: C:\Users\najea\OneDrive\Documents\Visual Studio 2017\Projects\1714anajera\1714anajera2f\AnamalShelterModel1.edmx
-- --------------------------------------------------
...
-- Creating foreign key on [Animal_Id] in table 'People'
ALTER TABLE [dbo].[People]
ADD CONSTRAINT [FK_AnimalPerson]
...
-- Creating non-clustered index for FOREIGN KEY 'FK_AnimalPerson'
CREATE INDEX [IX_FK_AnimalPerson]
ON [dbo].[People]
    ([Animal_Id]);
GO
